#!/bin/bash
# statusline.sh - GHOST/SAMANTHA statusline for Claude Code (multi-line, themed)
#
# Rows:
#   1. 幽霊 ghost@samantha identity · BRANCH · CWD · model · ctx bar+% · BKK/EST/PST · LIVE/OFFLINE
...
# Line 1 assembly
# ---------------------------------------------------------------------------
# Prefix glitch animation — 20-tick cycle.
#   Frame 0: original `幽霊 ghost.samantha ▸`
#   Frame i (1-19): first i positions replaced with glitch phrase
#   Glitch phrase reads: 公安 ｾｸｼｮﾝ9 ｺｳｱﾝｻﾏﾝｻ ▶ (kōan, section 9, kōan-samantha ▶)
